...
const MTROL_COMBAT_BANNERS = {
  "explosion primordial":
    "systems/mtrol-refactor-test/assets/skills/banners/explosion-primordial.png",
  "ojo de ulghur":
    "systems/mtrol-refactor-test/assets/skills/banners/ojo-de-ulghur.png",
  "cadenas infernales":
    "systems/mtrol-refactor-test/assets/skills/banners/cadenas-infernales.png",
  "farol del eter":
    "systems/mtrol-refactor-test/assets/skills/banners/farol-del-eter.png",
  "muro de fuego":
    "systems/mtrol-refactor-test/assets/skills/banners/muro-de-fuego.png",
  "orbe aumentado":
    "systems/mtrol-refactor-test/assets/skills/banners/orbe-aumentado.png",
  "orbe control":
    "systems/mtrol-refactor-test/assets/skills/banners/orbe-control.png",
  "orbe de control":
    "systems/mtrol-refactor-test/assets/skills/banners/orbe-control.png"
};
...
function getCombatBanner(item) {
  const banner =
    item.system?.banner?.trim();

  if (isValidImageSrc(banner)) return banner;

  return getSafeImageSrc(
    MTROL_COMBAT_BANNERS[normalizarNombreBanner(item.name)] ?? item.img,
